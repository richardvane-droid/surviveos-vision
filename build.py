...
<article class="mod about">
  ...
  <section class="blk"><h2><em>①</em> 框架是真的，内容是想的</h2>
    <p class="scene">{{ stats.areas }} 个区域和模块编号完全沿用真实项目的《0002 区域与子模块清单》（2026-09-09 新设 08 虚拟空间：0206 → 0801、0211 → 0802，新增 0803 miniduck；2026-09-14 再补 0307 CNC 五轴雕刻机、0804 全屋存储 + 全屋智能、0805 全套方案材质总设计）。5 个真实已完成的模块（0201 模拟阳光、0202 卫生间灯箱、0601～0603 草地三件套）和 6 个进行中的模块（0103 电子画框墙、0209 藏宝阁、0801 物品数字孪生、0307 / 0804 需求收集中、0805 铝型材已定标），设想内容在真实方案基础上放飞；其余模块是纯幻想。钓台区真实项目还没拆解，这里先替它想了 0701～0704 四个模块。每页右上角的状态章（⬜ / 🚧 / ✅ / 设想）标的是<b>真实进度</b>，不是设想进度。</p></section>

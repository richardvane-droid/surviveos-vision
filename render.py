...
async def main(paths, out):
    async with async_playwright() as p:
        ...
        html = html.replace("<figure>", '<figure style="margin:0;width:400px;text-align:center"><div style="border:1px solid #ccc;background:#f9f6ef">').replace("<figcaption>", "</div><figcaption>")
